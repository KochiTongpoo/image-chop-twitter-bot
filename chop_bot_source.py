        ...
        if data.startswith("{"):
            ...
            if "text" in data:
                ...
                if data['in_reply_to_screen_name'] == bot_name and "chop" in data['text']:
                    ...
                    #処理②：画像のリサイズ(opencv)
                    img = cv2.imread(r"C:\Users\ryu220nosuke\source\repos\PythonApplicationTest\PythonApplicationTest\download_twitter.jpg") #画像読み込み
                    ...
                    cv2.imwrite(r"C:\Users\ryu220nosuke\source\repos\PythonApplicationTest\PythonApplicationTest\out1.jpg", roi1)

                    cv2.imwrite(r"C:\Users\ryu220nosuke\source\repos\PythonApplicationTest\PythonApplicationTest\out2.jpg", roi2)
